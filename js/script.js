...
const skillData = {
    ...
    java: {
      ...
      descriptions: [
        "★☆☆☆☆: 基本的な文法（変数、if文、forループなど）を使って簡単なプログラムが書ける",
        "★★☆☆☆: クラスとオブジェクト指向の基本が理解できる",
        "★★★☆☆: コレクションフレームワークや例外処理、ファイル入出力が使える",
        "★★★★☆: スレッド、ネットワークプログラミング、JDBCを用いたDB操作ができる",
        "★★★★★: Springフレームワークや設計パターンを用いた大規模アプリケーション開発ができる"
      ]
    },
    ruby: {
      title: "Ruby",
      ...
      descriptions: [
        "★☆☆☆☆: 基本的な文法（変数、if文、forループなど）を使って簡単なプログラムが書ける",
        "★★☆☆☆: メソッド定義や配列、ハッシュの基本的な操作が理解できる",
        "★★★☆☆: クラスとオブジェクト指向、ブロックやイテレータが使える",
        "★★★★☆: Railsフレームワークを用いたWebアプリケーション開発ができる",
        "★★★★★: RubyのメタプログラミングやDSLの作成、高度なパフォーマンス最適化ができる"
      ]
    }      
  };
